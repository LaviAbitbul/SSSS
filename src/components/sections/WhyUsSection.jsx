        ...
        >
          ...
          <div>
            <p className="font-assistant text-deep/70 text-base leading-relaxed">
              אנחנו לא רק מספקים שירות משפטי – אנחנו מלווים אתכם בתקופה מאתגרת בחייכם. הגישה האישית, המקצועית והאמינה שלנו הפכה אותנו לכתובת הראשונה עבור מאות לקוחות מאילת והסביבה.
            </p>
          </div>
        </motion.div>
